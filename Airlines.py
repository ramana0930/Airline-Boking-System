...
Label(fr2,text="G.Ramana Gowda (1NH22CS073)",font=("Times New Roman",14),fg="Red",compound="center").pack()
Label(fr2,text="J.Munjunatha Royal (1NH22CS090)",font=("Times New Roman",14),fg="Red",compound="center").pack()
...
def airline():
    ...
    def signup():
                 ...
                 root=Tk()
                 root.title("Sign Up")
                 d=PhotoImage(file="cruise.png")
                 Label(root,image=d).grid(row=0,column=0,columnspan=4)
                 Label(root,text="Welcome to Cruise Booking Systems",font=("Times New Roman",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
                 ...
                 def signin():
                     ...
                     Label(root2,text="Welcome to Cruise Booking System",font=("Times New Roman",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
